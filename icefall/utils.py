...
def encode_supervisions(
    ...
    supervision_segments = torch.stack(
        ...
        1,
    ).to(torch.int32)  #tensor([[  0,   0, 500],[  1,   0, 473], [  2,   0, 473],[  3,   0, 462],[  4,   0, 458],
    
    indices = torch.argsort(supervision_segments[:, 2], descending=True)  #按长度排序
    supervision_segments = supervision_segments[indices]

    if token_ids is None: #
        texts = supervisions["text"] #["HOW DEAR AND GOOD IT IS OF YOU TOO BUT I WANT TO HEAR THESE LIPS OF YOURS WHICH ARE ALSO MINE UTTER IT FIRST THEN ITS MUSIC WILL BE PERFECT PLEASED TO THE MARROW SHE MURMURED HELLO CENTRAL I DIDN'T LAUGH", 'FINALLY I AGAIN SPREAD MY SWIFT WINGS REACHED THE BEAUTIFUL STAR ARCTURUS AND NOTICED AMONG THE WORLDS THAT REVOLVE AROUND IT A FEW THAT ARE SINLESS I WAS TEMPTED TO PAUSE AT ONE OR ANOTHER OF THESE EXCEPTIONAL STATIONS BUT I KNEW THAT I COULD NOT TARRY UNTIL I HAD REACHED THE FAR DISTANT CONSTELLATION OF SCORPIO', "I HAVE NOW PASSED MY BEST BUT YOU DON'T WANT TO CHANGE ME DO YOU NO WENDY CERTAINLY HE DID NOT WANT A CHANGE BUT HE LOOKED AT HER UNCOMFORTABLY BLINKING YOU KNOW LIKE ONE NOT SURE WHETHER HE WAS AWAKE OR ASLEEP PETER WHAT IS IT", 'COATED WITH SILVER BOTH INTENDED TO SERVE AS A TOMB FOR THE KING OF MIEN BEFORE HIS KINGDOM FELL UNDER THE DOMINION OF THE KHAN AFTER VISITING THIS PROVINCE THE TRAVELLER WENT TO BANGALA THE BENGAL OF THE PRESENT DAY', 'THE ESTATES WERE BACK AGAIN WITH THE WYLDERS A STATEMENT OF TITLE IS USUALLY A DRY AFFAIR BUT THAT OF THE DYNASTY OF BRANDON HALL WAS A TRUCULENT ROMANCE THEIR VERY WILLS WERE SPICED WITH THE DEVILMENT OF THE TESTATORS AND ABOUNDED IN INSINUATIONS AND EVEN LANGUAGE WHICH WERE SCANDALOUS', 'WE WERE ONLY BEGINNING TO GET ACCUSTOMED TO STEAMBOATS AND RAILROADS TO TRAVEL BY EITHER WAS SCARCELY LESS AN ADVENTURE TO US YOUNGER ONES THAN GOING UP IN A BALLOON PHRENOLOGY WAS MUCH TALKED ABOUT AND NUMEROUS PROFESSORS OF IT CAME AROUND LECTURING AND EXAMINING HEADS', 'THE OLD MAN BLINKED RAPIDLY THEN CONQUERED HIS PRIDE WITH PUNCTILIOUS CARE HE UNBUTTONED HIS GRAY CUTAWAY TOOK OUT A WALLET FROM UNDER THE BUTTON OF THE SOCIETY OF COLONIAL WARS DREW FORTH A SHEET OF NOTE PAPER AND WITH A PENCIL INSCRIBED A BROAD O', "IN THE PRESENT CIRCUMSTANCES PUBLICITY IS A PART OF SAFETY DO NOT BE SURPRISED IF WHILST WE ARE AT DIANA'S GROVE OCCASIONAL MESSAGES COME FOR YOU FOR ALL OR ANY OF US I SEE SAID MISSUS SALTON YOU ARE TAKING NO CHANCES NONE MY DEAR", "SUDDENLY HE MADE A QUICK MOVEMENT AND THE CAR BENEATH THEM LEAPED FORWARD LIKE A CHARGER THAT FEELS THE PRICK OF THE SPUR THE GIRL GAVE A FRIGHTENED CRY THEN A TREMULOUS LITTLE SOB OF JOY THE MAN HAD CRIED IN HER EAR IN RESPONSE TO HER QUESTIONING EYES WE'RE GOING TO AUNT JANE", 'FLORINA SHUT UP IN HER TOWER LAMENTED BITTERLY AH WOULD I HAD BEEN SENT HERE BEFORE I SAW THIS AMIABLE PRINCE WHO WAS SO KIND TO ME IT IS TO PREVENT MY MEETING HIM AGAIN THAT THE QUEEN TREATS ME SO CRUELLY']
